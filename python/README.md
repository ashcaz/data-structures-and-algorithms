...
12. Can successfully peek into a queue, seeing the expected value
13. Can successfully empty a queue after multiple dequeues
14. Can successfully instantiate an empty queue
